...
export const EXPERIENCES = [
   {
    ...
    company: "Tridenzic",
    description: `Built a full stack website for a salonist based in Bangalore. Check my work: <a href="https://trystsalonandacademy.com" target="_blank" rel="noopener noreferrer" class="text-purple-400 underline">trystsalonandacademy.com</a>. Many more projects to be revealed soon...`,
